...
clear all
clc
z=bioJoint('sdfsdfsdf','node');
y=bioJoint('poi','node');
x=bioJoint('ert','node');
b=bioLinkage('linkage');
b.addJoints(x,y,z);
c=sandboxClass2(b);

save('C:\Users\alberto-bortoni\Desktop\sandbox\fistStudy\test.mat', 'c')
...
clear all
clc
load('C:\Users\alberto-bortoni\Desktop\sandbox\fistStudy\test.mat')
